const Contact = () => (
  <section id="contact" className="py-16 bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-800 dark:to-gray-900">
    <div className="max-w-4xl mx-auto px-4">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold mb-4 text-gray-900 dark:text-white">Get Started Today</h2>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
          <h3 className="text-xl font-semibold mb-6 text-gray-900 dark:text-white">Business Inquiries</h3>
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Schedule a personalized demo of our solutions</p>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white">Partnership Opportunities</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Explore collaboration and integration possibilities</p>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white">Custom Solutions</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Tailored implementations for your specific needs</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              <div className="bg-blue-100 dark:bg-blue-900/20 w-8 h-8 rounded-full flex items-center justify-center mr-3">
                <svg className="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center">
              <div className="bg-purple-100 dark:bg-purple-900/20 w-8 h-8 rounded-full flex items-center justify-center mr-3">
                <svg className="w-4 h-4 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="text-center">
        <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
          <h3 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Ready to Get Started?</h3>
